...
namespace ArcTim
{
    ...
    /// </summary>
    [Guid("fff85839-f477-49b9-bed9-d51cb8b6511a")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("ArcTim5.OutputSettingsCommand")]
    public sealed class OutputSettingsCommand : BaseCommand
    {
        ...
        public OutputSettingsCommand()
        {
            //
            // TODO: Define values for the public properties
            //
            base.m_category = "Output Settings"; //localizable text
            base.m_caption = "Output Settings";  //localizable text
        ...
        public override void OnClick()
        {
            if (m_hookHelper != null)
            {
                OutputSettings os = new OutputSettings(m_application, m_hookHelper);
                os.Show();
            }
